...
def main():
    msg = Message(slack_instance=SlackInstance(name='beacon'), conversation=Channel(name='general'),
                  author='fm', text="""Czym jest Lorem Ipsum?
